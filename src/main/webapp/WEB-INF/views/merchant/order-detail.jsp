...
<c:if test="${sessionScope.a==1}">
    <a class="btn btn-primary btn-orderDetail" href="${ pageContext.request.contextPath }/merchant/order/received/${sessionScope.orderId}">Nhận đơn</a>
    <a class="btn btn-primary btn-orderDetail" href="${ pageContext.request.contextPath }/merchant/order/refuse/${sessionScope.orderId}">Từ chối</a>
</c:if>
