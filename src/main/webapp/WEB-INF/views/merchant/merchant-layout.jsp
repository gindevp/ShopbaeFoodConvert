          ...
          <div class="user-acc-contain">
            ...
            <div class="user-acc-dropdown">
             <a href="${ pageContext.request.contextPath }/logout"><button type="button"  class="btn btn-none-bg btn-login">
                  <span class="font14"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"/>
  <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
</svg> <spring:message code="logout"/></span>
                </button></a>
            </div>
          </div>
...
<div class="now-container-coporation now-container-content">
    ...
    <nav id="sidebarMenu" style="background-color:#ffffff!important; border-radius: 7px" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item" >
            <a class="nav-link <c:if test="${nav==1 }">active</c:if> nav-item-hover" aria-current="page" href="${ pageContext.request.contextPath }/merchant">
  ...
  <path d="M4 11H2v3h2v-3zm5-4H7v7h2V7zm5-5v12h-2V2h2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1h-2zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3z"/>
          ...
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==2 }">active</c:if> nav-item-hover" href="${ pageContext.request.contextPath }/merchant/order">
              ...
              <spring:message code="order_manager"/>
            </a>
          </li>
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==3 }">active</c:if> nav-item-hover" href="${ pageContext.request.contextPath }/merchant/product">
              ...
              <spring:message code="product_manager"/>
            </a>
          </li>
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==4 }">active</c:if> nav-item-hover" >
          ...
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==5 }">active</c:if> nav-item-hover" href="${ pageContext.request.contextPath }/merchant/detail">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-postage" viewBox="0 0 16 16">
...
<jsp:include page="/WEB-INF/views/merchant/${page}"></jsp:include>
