...
<div class="now-container-coporation now-container-content">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item" >
            <a class="nav-link <c:if test="${nav==1 }">active</c:if> nav-item-hover" aria-current="page" href="/ShobaeFood/merchant">
  ...
  <path d="M4 11H2v3h2v-3zm5-4H7v7h2V7zm5-5v12h-2V2h2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1h-2zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3z"/>
          ...
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==2 }">active</c:if> nav-item-hover" href="/ShobaeFood/merchant/order">
          ...
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==3 }">active</c:if> nav-item-hover" href="/ShobaeFood/merchant/product">
          ...
          <li class="nav-item " >
            <a class="nav-link <c:if test="${nav==5 }">active</c:if> nav-item-hover" href="/ShobaeFood/merchant/detail">
