      ...
      <div class="">
        ...
        <div class="setting-card-row desc">
          <div class="main"><i class="icon shopee-icon">
            ...
            <div class="info">
              <a class="info-input subtitle btn btn-dark" (click)="setLocalStorage()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-exclamation" viewBox="0 0 16 16">
        ...
        <div class="setting-card-row desc">
          <div class="main">
            <i class="shopee-icon-i fa-regular fa-clock"></i>
...
<div style="align-content: center">
  ...
  <button [disabled]="disabeled||adisabeled"  type="button" class="right-button-2" (click)="updateMerchantInfo()" (click)="addNewAccount()">
