        ...
        <div class="container">
          <div class="header-content navbar row  justify-content-between align-items-center">
            <div class="logo-now col-auto"><span><a href="${ pageContext.request.contextPath }/home"><img
              src="${ pageContext.request.contextPath }/static/img/shopeefoodvn.png"
            ...
            <div class="user-acc col-auto user-acc-wr">
                ...
                <a href="${ pageContext.request.contextPath }/logout"><button type="button"  class="btn btn-none-bg btn-login">
                  <span class="font14"><span class="font14"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
...
<!--          </li>-->
<!--          <li class="nav-item">-->
<!--            <a class="nav-link" routerLink="merchant-list">-->
...
<!--          </li>-->
          <li class="nav-item " >
            ...
            <a class="nav-link <c:if test="${nav==1 }">active</c:if> nav-item-hover" href="${ pageContext.request.contextPath }/admin/merchant">
          ...
          <li class="nav-item " >
          <c:if test=""></c:if>
            <a class="nav-link <c:if test="${nav==2 }">active</c:if> nav-item-hover" href="${ pageContext.request.contextPath }/admin/user" routerLinkActive="selected">
...
<!--    <app-merchant-list class="col-md-9 ms-sm-auto col-lg-10 px-md-4"></app-merchant-list>-->
   ...
   <div>
     <h1 class="h2">Quản lý ${manager}</h1>
     <div>
  <!-- nav options -->
  <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist" style="background-color: white;">
    <li class="nav-item">
      <a class="nav-link <c:if test="${nav2==1 }">active</c:if> link fw-bold"  id="pills-home-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }/pending" role="tab"  routerLinkActive="selected"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus-fill" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm6.5-11a.5.5 0 0 0-1 0V6H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V7H10a.5.5 0 0 0 0-1H8.5V4.5z"/>
      </svg> Chờ duyệt</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <c:if test="${nav2==2 }">active</c:if> link fw-bold" id="pills-profile-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }" role="tab"  routerLinkActive="selected" [routerLinkActiveOptions]="{exact: true}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
        <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z"/>
      </svg> Đang hoạt động</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <c:if test="${nav2==3 }">active</c:if> link fw-bold" id="pills-contact-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }/block" role="tab"  routerLinkActive="selected"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
        <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/>
      </svg> Đang bị khóa</a>
    </li>
  </ul><jsp:include page="/WEB-INF/views/admin/${page}"></jsp:include>
  </div>
   </div>
  </div>
