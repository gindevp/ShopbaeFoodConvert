...
<!--          </li>-->
          <li class="nav-item " >
            ...
            <a class="nav-link <c:if test="${nav==1 }">active</c:if> nav-item-hover" href="/ShobaeFood/admin/merchant">
          ...
          <li class="nav-item " >
          <c:if test=""></c:if>
            <a class="nav-link <c:if test="${nav==2 }">active</c:if> nav-item-hover" href="/ShobaeFood/admin/user" routerLinkActive="selected">
