        ...
        <div class="container">
          <div class="header-content navbar row  justify-content-between align-items-center">
            <div class="logo-now col-auto"><span><a href="${ pageContext.request.contextPath }/home"><img
              src="/ShobaeFood/static/img/shopeefoodvn.png"
...
<!--          </li>-->
          <li class="nav-item " >
            <a class="nav-link nav-item-hover" href="/ShobaeFood/admin/merchant" routerLinkActive="selected">
          ...
          <li class="nav-item " >
            <a class="nav-link nav-item-hover" href="/ShobaeFood/admin/user" routerLinkActive="selected">
...
<!--    <app-merchant-list class="col-md-9 ms-sm-auto col-lg-10 px-md-4"></app-merchant-list>-->
  ...
  <ul class="nav nav-pills mb-3 shadow-sm" id="pills-tab" role="tablist">
    <li class="nav-item">
      <a class="nav-link link fw-bold"  id="pills-home-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }/pending" role="tab"  routerLinkActive="selected"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus-fill" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm6.5-11a.5.5 0 0 0-1 0V6H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V7H10a.5.5 0 0 0 0-1H8.5V4.5z"/>
      </svg> Chờ duyệt</a>
    </li>
    <li class="nav-item">
      <a class="nav-link link fw-bold" id="pills-profile-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }" role="tab"  routerLinkActive="selected" [routerLinkActiveOptions]="{exact: true}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
    ...
    <li class="nav-item">
      <a class="nav-link link fw-bold" id="pills-contact-tab" data-toggle="pill" href="${ pageContext.request.contextPath }/admin/${manager }/block" role="tab"  routerLinkActive="selected"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
